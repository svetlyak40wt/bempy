...
def guide(request):
    return b.page(content=b.guideline(
        ('BEM Button',
         b.bem_button(text="Default"),
         b.bem_button(text="Normal S", theme='islands', size='s'),
         b.bem_button(text="Action S", theme='islands', size='s', view='action')
        ),
        ('Islets Button',
         b.y_button(text="Default"),
        ),
        ('BEM Menu',
         b.bem_menu('Один', 'Два', 'Три'),
         b.bem_menu('Один', 'Два', 'Три', theme='islands', size='m'),
        ),
        ('BEM Dropdown',
         b.bem_dropdown('Кликни меня', 'Ого, ты и правда кликнул?'),
         b.bem_dropdown('Кликни меня', 'Ого, ты и правда кликнул?',
                        switcher='button'),
        ),
        ('BEM Dropdown with Menu',
         b.bem_dropdown('Кликни меня', b.bem_menu('Один', 'Два', 'Три')),
        ),
        
        ('Button', b.button(text="The Button")),
